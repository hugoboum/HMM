...
The initial probability distribution of states is defined by the vector $\boldsymbol{\pi_{1}} = (\mathbb{P}(S_{1}=i))_{i}$. \newline

The non-conditional density of $Y_{t}$ is:
\[
\sum\limits_{n=1}^{k}   \pi_{t,k}p(Y_{t} | \mu_{k},\sigma_{k})
\]
